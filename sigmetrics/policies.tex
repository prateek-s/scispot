...
%
However, the bathtub nature of constrained preemptions requires new checkpointing policies that are not rooted in the memoryless assumption, which we develop in this subsection.  
