...
Our bathtub probability model allows us to develop optimized job-scheduling policies for reducing the overheads of preemptions, which we develop below. 
...
%
However, the bathtub nature of constrained preemptions requires new checkpointing policies, which we develop in this subsection. 
