...
%
Recent work~\cite{tian_gpu_icdcs} has also found evidence of the bath-tub failure distribution for Google Preemptible GPU VMs, and confirms our observations. 
