...
Publicly available\footnotemark historical spot prices have been used to characterize and model spot instance preemptions~\cite{spotcheck, bid-cloud, transient-guarantees, wolski2016providing}. %Add lots more here 
...
%
Therefore in this paper, we propose an empirical approach for modeling preemptions. 
Our empirical data and the resulting preemption model allows the development of preemption mitigation policies for temporally constrained preemptions. 
%
...
%
Spot instance preemptions can be modeled using \emph{memoryless}  exponential distributions~\cite{bid-cloud, hotcloud-not-bid, flint, ghit-spark-hpdc, chien-ic2e19}. 
However, the 24 hour constraint precludes such memoryless assumptions, require new modeling techniques and policies, because constrained preemptions are not memoryless. 
%
