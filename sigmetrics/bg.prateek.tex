...
%
Prior work has indicated the usefulness and value of even coarse-grained preemption statistics such as MTTF~\cite{chien-ic2e19}---however even they are unvailable for cloud platforms other than Amazon EC2. 
%
Therefore in this paper, we seek to develop an empirical model of preemptions of Google Preemptible VMs~\cite{preemptible-documentation}.
Our empirical data and preemption model allows the development of preemption mitigation policies for temporally constrained preemptions. 
%
