...
\begin{figure*}
  ...
  {  \includegraphics[width=0.35\textwidth]{../graphs/scispot-fig-vm-types.eps} }
  \hfill
\subfloat[Variations due to time of day and workload. \label{fig:time-breakdown}]
{  \includegraphics[width=0.3\textwidth]{../gnuplot_analysis/time-breakdown.pdf} }
\hfill
\subfloat[By region. \label{fig:time-breakdown}]
{  \includegraphics[width=0.3\textwidth]{../gnuplot_analysis/time-breakdown.pdf} }
...
The idea of excluded volume is central in physics and materials engineering where it underpins the origin of entropic forces in material systems, and is characterized by the partition function in statistical mechanics~\cite{kreuth}. 
...
The probability of finding 1 preemption near the deadline at $t=L-w$ is given as the ratio of the two computed volumes.
That is, $P(L-w) = \frac{Z_1}{Z} = \frac{1}{(L - Nw)} > \frac{1}{L}$ , since $N \geq 1$ and $w>0$.
