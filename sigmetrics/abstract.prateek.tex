...
In this paper, we conduct a first of its kind empirical study of the preemption behavior of Google's Preemptible VMs, 
...
Our statistical analysis indicates that preemptions of Google Preemptible VMs are \emph{not} uniformly distributed, but have three distinct temporal phases, which introduces new challenges in failure modeling.  
