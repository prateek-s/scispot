...
%In this paper, we present a large-scale empirical study  and statistical analysis of the preemption behavior of Google's Preemptible VMs, that have a distinguishing characteristic of having a \emph{maximum} lifetime of 24 hours. 
%The temporal constraint introduces many challenges, since e
%
...
%have three distinct temporal phases, which introduces new challenges in failure modeling.  
