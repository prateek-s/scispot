Transient cloud servers such as Amazon Spot instances, Google Preemptible VMs, and Azure Low-priority batch VMs, can reduce cloud computing costs by as much as $10\times$.
...
Our statistical analysis indicates that preemptions are \emph{not} uniformly distributed, but have distinct temporal phases, which introduces new challenges in failure modeling.  % and permits new techniques from statistical mechanics to be used.
