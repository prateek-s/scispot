...
Our large-scale empirical study shows that the constraint imposes a bathtub failure distribution, and we develop a new pre\vikram{e}mption probability model for capturing its three distinct temporal phases. 
