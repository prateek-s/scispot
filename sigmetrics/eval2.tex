...
For the bathtub distribution, the wasted work is given by Equation~\ref{eq:wasted}. \vikram{We find that compared to the uniform case, the bathtub distribution yields on average XXX hours smaller waste for jobs longer than 5 hours, a significant reduction in the wasted work.} %\emph{significantly} lower, especially for longer jobs (longer than 5 hours). 
...
%hl 
With our policy, the running times increase by 10\% for short jobs ($<2$  hours), and increase by less than 5\% for longer jobs, \vikram{staying at XXX amount on average}.
...
We see that for all the three applications, using our service can reduce costs by $5\times$ \vikram{you can make this precise by just giving numbers for each application and then saying, on average cost reduction is by 5 times}.
