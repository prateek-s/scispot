...
This is increasingly prevalent in applications that combine simulations and machine learning, such as the use of ``ML surrogtes'' that require physical systems to be simulated with a large number of different parameters to generate the required training data for neural network models to be able to predict the output parameters with high accuracy~\cite{kadupitiya2020machine2}. 
