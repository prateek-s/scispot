...
%which we then provide a statistical mechanics interpretation for. 
...
\begin{figure}
 \centering  \includegraphics[width=0.44\textwidth]{../data/gnuplot-figures/sigmetrics-fig-cdf-prob-inset-time.pdf} 
...
% Above is too meta and useful only to prateek 
...
%
%Empirically, our main observation is: \emph{The lifetimes of VMs are not uniformly distributed, but have three distinct phases.}
...
\begin{figure}
  ...
  {\includegraphics[width=0.34\textwidth]{../data/TPDS_Figures/weekdays-vs-weekends.pdf}}
  \\
  \vspace*{-10pt}
\subfloat[Parallel VM launches. \label{fig:cdf-concurr}]
{\includegraphics[width=0.34\textwidth]{../data/TPDS_Figures/different-numbers-of-parallel-VM-launches.pdf}}
...
% \vikram{This sentence needs to be re-worded:: Presumably, this could be a result of the lower resource utilization of idle VMs being more amenable to resource overcommitment, and result in lower preemptions.}
% Great point, but too deep :) 
