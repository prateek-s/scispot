...
%
Furthermore, no other information about preemption characteristics is publicly available, not even coarse-grained \vikram{is the use of the word CG ok for this community? could say steady-state metrics or statistical averages such as MTTFs} metrics such as MTTFs. 
%
...
We implement and evaluate these policies as part of a batch computing service, SciSpot, which we also use for empirically evaluating the effectiveness of our model and policies under real-world conditions. 
