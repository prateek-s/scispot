...
%
We find that preemption rates are \emph{not} uniform, but in most cases are bathtub shaped with multiple distinct temporal phases.
Even existing bathtub distributions such as Weibull are unable to accurately model the empirically observed failure distributions. 
%
