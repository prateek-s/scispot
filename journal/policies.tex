...
\textbf{Practical Relevance:} This policy does not require job running times, only a relative measure if job length is greater or smaller than some threshold or not. 
