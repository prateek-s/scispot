...
Thus, the bathtub distribution can be considered to be a general artifact of constrained preemptions. Of course, the empirical preemption distribution is determined by the cloud platform's policies and supply and demand, and we elaborate more about the generality of our model and observation in Section~\ref{sec:discussion}. \vikram{will we add discussion at the end?}
...
\begin{figure}[t]
  ...
  \label{fig:partfun}
  \caption{Preemption probability computed using the partition function defined for a simple constrained system is also bathtub shaped. \vikram{the figure needs to be cited in the text; not sure where and how you want to refer to it?}}
\end{figure}
