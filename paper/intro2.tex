...
These applications are usually parallelized and require a large amount of computing resources, and are deployed on large, dedicated high performance computing (HPC) infrastructure such as super computers. \prat{add some refs.}
...
Conventional HPC resource management frameworks such as Slurm~\cite{} and Torque~\cite{} typically assume static, homogenous clusters, and are not cognizant of transient availability and the plethora of choices in cloud VM sizes and pricing. %, for effective resource utilization. 
...
\prat{Not sure if this is needed..}
