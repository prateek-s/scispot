...
and diversification~\cite{exosphere, spotweb} can indeed mitigate the effect of preemptions on a single job, these techniques are not suitable for the bags of jobs execution model. 
