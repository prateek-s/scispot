...
%
 To address the lack of historical preemption information in the Google Cloud, we conduct the first large-scale empirical study of preemption rates by launching more than a thousand VMs, and analyze and model their preemptions in Section~\ref{sec:preemption-dynamics}.
