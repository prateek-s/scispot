...
%
SciSpot deploys applications on Google Cloud Preemptible VMs, and introduces the first empirical and analytical model for their preemptions, which we use to develop policies for minimizing the cost and makespan.
...
For any given bag of job, SciSpot finds the optimal transient server on-the-fly, by taking into account their price, performance, and preemption rates. 
